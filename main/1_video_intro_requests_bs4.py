...
def main():
    ...
    url = ('https://www.dcz.gov.ua/userSearch/vacancy?koatuuVal=101010510100000&koatuuLab='
           '%D0%92%D1%96%D0%BD%D0%BD%D0%B8%D1%86%D1%8F&regionID=101010500000000&activePage=1&itemsPerPage=100')
    print(get_data(get_html(url, url_proxy)))
